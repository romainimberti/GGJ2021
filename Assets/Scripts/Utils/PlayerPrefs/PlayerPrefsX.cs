...
namespace com.romainimberti.ggj2021.utilities
{
    ...
    {
        #region Enums
        public enum ArrayType { Float, Int32, Bool, String, Vector2, Vector3, Quaternion, Color }
        #endregion
        ...
        /// <param name="value">Value for the preference</param>
        ...
        /// </summary>
        /// <param name="key">Key for the preference</param>
        /// <param name="vector">Value for the preference</param>
        ...
        /// </summary>
        /// <param name="key">Key for the preference</param>
        /// <param name="color">Value for the preference</param>
        ...
        /// </summary>
        /// <param name="key">Key for the preference</param>
        /// <param name="stringArray">Value for the preference</param>
        ...
        /// </summary>
        /// <param name="key">Key for the preference</param>
        /// <param name="intArray">Value for the preference</param>
        ...
        /// </summary>
        /// <param name="key">Key for the preference</param>
        /// <param name="floatArray">Value for the preference</param>
        ...
        /// </summary>
        /// <param name="key">Key for the preference</param>
        /// <param name="vector2Array">Value for the preference</param>
        ...
        /// </summary>
        /// <param name="key">Key for the preference</param>
        /// <param name="vector3Array">Value for the preference</param>
        ...
        /// </summary>
        /// <param name="key">Key for the preference</param>
        /// <param name="quaternionArray">Value for the preference</param>
        ...
        /// </summary>
        /// <param name="key">Key for the preference</param>
        /// <param name="colorArray">Value for the preference</param>
