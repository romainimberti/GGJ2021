...
namespace nl.DTT.LocalizedLanguage.Texts
{
    ...
    public class TMPTranslatedText : AbstractTranslatedText
    {
        #region Variables
        /// <summary>
        /// Text-Component
        ...
        {
            LoggingLevel.Development.Log(string.Format("TMPTranslatedText[{0}]: Grabbing Text Object", name),
                logLevel, this, logMethods);
            textComponent = GetComponent<TMP_Text>();
            LoggingLevel.Debug.Log(
                string.Format("TMPTranslatedText[{0}]: Loaded TextObject: {1}", name, textComponent != null),
